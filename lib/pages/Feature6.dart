...
class _Feature6State extends State<Feature6> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan puisi yang menarik berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Saat Mesin Berbicara',
    'Antara Pikiran dan Algoritma',
    'Lirik dari Data',
  ];
