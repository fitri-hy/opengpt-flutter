...
class _Feature9State extends State<Feature9> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan sebuah Sinopsis yang menarik berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Kecerdasan Buatan: Transformasi Teknologi di Era Digital',
    'Potensi dan Tantangan AI dalam Kehidupan Modern',
    'Peran AI dalam Meningkatkan Efisiensi dan Kepintaran Manusia',
  ];
