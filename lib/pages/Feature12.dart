...
class Feature12 extends StatefulWidget {
  @override
  _Feature12State createState() => _Feature12State();
}

class _Feature12State extends State<Feature12> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan surat yang menarik dan profesional berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
