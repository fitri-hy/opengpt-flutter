...
class Feature13 extends StatefulWidget {
  @override
  _Feature13State createState() => _Feature13State();
}

class _Feature13State extends State<Feature13> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan format email yang menarik dan profesional berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
