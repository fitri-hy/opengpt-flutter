...
class Feature10 extends StatefulWidget {
  @override
  _Feature10State createState() => _Feature10State();
}

class _Feature10State extends State<Feature10> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan sebuah format laporan berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Analisis Etika dan Privasi dalam Penggunaan Artificial Intelligence',
    'Efisiensi Operasional dan Transformasi Bisnis dengan AI',
    'Evaluasi Kesiapan dan Risiko Penerapan AI di Berbagai Industri',
  ];
