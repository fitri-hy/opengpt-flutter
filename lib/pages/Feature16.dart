...
class Feature16 extends StatefulWidget {
  @override
  _Feature16State createState() => _Feature16State();
}

class _Feature16State extends State<Feature16> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan sebuah ulasan produk yang menarik seolah-olah anda baru saja membelinya dan mendapatkan pengalaman baru berdasarkan tulisan yang di berikan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
