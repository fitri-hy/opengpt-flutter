...
class _Feature7State extends State<Feature7> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan daftar isi berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Edukasi dasar Artificial Intelligence',
    'Konsep kerja kecerdasan buatan',
    'Analisa pengembangan AI',
  ];
