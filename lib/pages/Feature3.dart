...
class _Feature3State extends State<Feature3> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan postingan untuk sosial media yang menarik berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Pengembangan AI',
    'Promosikan Produk AI',
    'Inovasi AI dalam sosial media',
  ];
