...
class _Feature5State extends State<Feature5> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan ringkasan dari pertanyaan yang di ajukan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Dalam beberapa tahun terakhir, AI telah membawa perubahan signifikan di berbagai sektor, termasuk teknologi, kesehatan, otomotif, dan keuangan. Contohnya adalah penggunaan AI dalam pengembangan perangkat lunak pengenalan suara, asisten virtual, dan sistem rekomendasi yang mempermudah interaksi manusia dengan teknologi. AI juga berkontribusi dalam meningkatkan efisiensi operasional, membantu diagnostik medis, serta mendorong inovasi dalam pengembangan produk dan layanan baru yang lebih cerdas dan terpersonalisasi.',
  ];
