...
class Feature17 extends StatefulWidget {
  @override
  _Feature17State createState() => _Feature17State();
}

class _Feature17State extends State<Feature17> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan sebuah Rekomendasi pilihan yang menarik berdasarkan tulisan yang di berikan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Rekomendasi nama produk AI',
    'Dimana pasar yang cocok untuk kecerdasan buatan',
    'Rekomendasi Pengembangan Artificial Intelligence',
  ];
