...
class _Feature11State extends State<Feature11> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan Proposal profesional berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Pengembangan AI untuk Proses Bisnis',
    'Tantangan AI dalam Pengelolaan Data',
    'AI dalam Prediksi Data',
  ];
