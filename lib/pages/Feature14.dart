...
class Feature14 extends StatefulWidget {
  @override
  _Feature14State createState() => _Feature14State();
}

class _Feature14State extends State<Feature14> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan sebuah artikel yang menarik berdasarkan judul yang di berikan maksimal 300 kata. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Masa Depan Artificial Intelligence dan Dampaknya pada Industri',
    'Keunggulan dan Tantangan Penggunaan AI dalam Kehidupan Sehari-hari',
    'Penerapan AI dalam Teknologi Modern: Peluang dan Risiko',
  ];
