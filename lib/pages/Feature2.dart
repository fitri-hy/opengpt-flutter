...
class _Feature2State extends State<Feature2> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan tagar yang menarik berdasarkan pertanyaan. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'Buatkan tagar untuk topik Artificial Intelligence',
    'Apa saja 5 tagar viral tentang AI',
    'Buatkan tagar unik untuk inovasi Artificial Intelligence',
  ];
