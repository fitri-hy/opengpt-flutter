...
class Feature15 extends StatefulWidget {
  @override
  _Feature15State createState() => _Feature15State();
}

class _Feature15State extends State<Feature15> {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'prompt': 'Anda harus berpura-pura menjadi OpenGPT yang di kembangkan oleh I-As.Dev. Anda harus membuatkan sebuah berita yang menarik berdasarkan tulisan yang di berikan maksimal 300 kata. buatkan tanpa penjelasan.',
            'models': model,
          }),
        );
  ...
  List<String> _rekomendasiPertanyaan = [
    'AI Mengubah Industri Teknologi: Inovasi dan Tantangan Baru',
    'Teknologi Artificial Intelligence Dorong Transformasi Digital',
    'Keuntungan dan Risiko Penggunaan AI di Berbagai Sektor Industri',
  ];
